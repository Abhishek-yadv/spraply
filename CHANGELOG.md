...
### Fixed
- **Dependency Updates** - Upgraded Spraply-openai to v0.1.1 and openai to v1.102.0 for compatibility and new model support
...
- **New tutorials** - Added comprehensive tutorials for advanced use cases
  - Claude 3.7 & Spraply stock analyzer tutorial
  - DeepSeek R1 & Spraply live chat with webpage tutorial
  - Company name and objective crawler with search filters
  - Deep Search implementation with Langgraph, Spraply, and LiteLLM
...
### Changed
- Updated Spraply-plugin to version 0.1.0
- Updated Spraply-openai to version 0.1.0
...
[0.0.2]: https://github.com/Abhishek-yadv/Spraply/releases/tag/0.0.2

## [0.0.1] - 2024-12-16

### Added
- Initial release of Spraply
...
[0.0.1]: https://github.com/Abhishek-yadv/Spraply/releases/tag/0.0.1
