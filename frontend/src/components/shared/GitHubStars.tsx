  ...
  return (
    <div className={`overflow-hidden rounded-lg border border-blue-800/30 bg-blue-900/20 shadow-md hover:shadow-lg transition-shadow ${className}`}>
      <div className="px-4 py-3">
        <h3 className="text-sm font-medium text-blue-100 drop-shadow">Support Spraply</h3>
        <p className="mt-1 text-xs text-blue-300">
          If you find Spraply useful, please consider giving us a star on GitHub!
        </p>
      </div>
      <div className="flex items-center justify-between bg-blue-800/30 px-4 py-2">
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs font-medium text-blue-200">
            {isLoading ? 'Loading...' : `${stars?.toLocaleString()} stars`}
          </span>
        </div>
        <a
          href={repoUrl}
