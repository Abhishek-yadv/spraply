        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-6 shadow sm:rounded-lg">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Spraply has been successfully installed. You can now start using the system.
            </p>
            <button
              type="button"
              onClick={goToHome}
              ...
              <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-4 space-y-5">
                ...
                <div className="flex items-start pb-4 border-b border-gray-200 dark:border-gray-600">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="acceptLicense" className="font-medium text-gray-700 dark:text-gray-300">
                      I accept and agree to follow the license policies of Spraply
                    </label>
                    <p className="text-gray-500 dark:text-gray-400 mt-1">
                      You can read the latest version <a href="https://github.com/Abhishek-yadv/Spraply/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-primary-600 hover:text-primary-500 dark:text-primary-400 underline">here</a>.
                    </p>
                ...
                <div className="flex items-start py-4 border-b border-gray-200 dark:border-gray-600">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">
                      We'll send you Spraply updates, new features, and important announcements.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start pt-4">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">
                      Help us improve Spraply by sending anonymous installation and usage data.
                    </p>
                    <div className="mt-2 p-3 bg-gray-100 dark:bg-gray-800 rounded text-xs text-gray-600 dark:text-gray-400">
                      ...
                      <p className="mt-2">All data is collected anonymously and used only for improving Spraply.</p>
                    </div>
                  </div>
                </div>
              </div>
