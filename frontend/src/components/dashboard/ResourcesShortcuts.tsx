...
export const ResourcesShortcuts: React.FC = () => {
  ...
  const resources: ResourceLink[] = [
    ...
    },
    {
      ...
      href: 'https://docs.spraply.dev/api/overview',
      icon: BookOpenIcon,
      external: true,
    ...
    },
    {
      ...
      href: 'https://github.com/Abhishek-yadv/Spraply/tree/main/tutorials',
    ...
    },
    {
      ...
      href: 'https://github.com/Abhishek-yadv/Spraply/discussions',
    ...
    },
    {
      ...
      href: 'https://github.com/Abhishek-yadv/Spraply/issues',
      icon: BugAntIcon,
      external: true,
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600">
        <div className="flex flex-wrap gap-3">
          ...
          <a
            href="mailto:support@spraply.dev"
            className="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
          >
