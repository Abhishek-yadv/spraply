...
```bash
curl "https://api.spraply.dev/api/v1/core/crawl-requests/?page=1&page_size=10" \
...
{
    "count": 123,
    "next": "http://api.spraply.dev/api/v1/core/crawl-requests/?page=4",
    "previous": "http://api.spraply.dev/api/v1/core/crawl-requests/?page=2",
    "results": [
        {
            "uuid": "123e4567-e89b-12d3-a456-426614174000",
            "url": "https://example.com",
