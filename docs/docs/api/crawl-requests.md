...
The Core Crawl-Requests API allows you to manage web crawling operations in Spraply. This section covers how to start new crawls, monitor their status, and retrieve results.
