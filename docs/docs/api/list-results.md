...
```bash
curl "https://api.spraply.dev/api/v1/core/crawl-requests/123e4567-e89b-12d3-a456-426614174000/results/?page=1&page_size=10" \
...
// Initialize client
const client = new SpraplyAPIClient('your_api_key');
...
{
    'count': 123,
    'next': 'https://api.spraply.dev/api/v1/core/crawl-requests/123e4567-e89b-12d3-a456-426614174000/results/?page=4',
    'previous': 'https://api.spraply.dev/api/v1/core/crawl-requests/123e4567-e89b-12d3-a456-426614174000/results/?page=2',
    'results': [
        {
            'uuid': '123e4567-e89b-12d3-a456-426614174000',
            'url': 'https://example.com/page',
            'status': 'success',
            'result': "https://storage.spraply.dev/results/123e4567-e89b-12d3-a456-426614174000.json",
            'attachments': [
                {
                    'uuid': '095be615-a8ad-4c33-8e9c-c7612fbf6c9f',
                    'attachment': 'https://storage.spraply.dev/123e4567-e89b-12d3-a456-426614174000.pdf',
                    'attachment_type': 'pdf',
