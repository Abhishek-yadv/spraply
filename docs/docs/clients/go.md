...
A Go client library for the Spraply API. This client provides a simple and intuitive way to interact with Spraply's web crawling service.

## Installation

```bash
go get github.com/Abhishek-yadv/Spraply-go
```
...
```go
import "github.com/Abhishek-yadv/Spraply-go"

client := Spraply.NewClient("your-api-key", "")  // Empty string uses default base URL
```
...
Please see [CONTRIBUTING.md](https://github.com/Abhishek-yadv/Spraply-go/blob/main/CONTRIBUTING.md) for details on how to contribute to this project.

## License

This project is licensed under the MIT License - see the [LICENSE](https://github.com/Abhishek-yadv/Spraply-go/blob/main/LICENSE) file for details. 