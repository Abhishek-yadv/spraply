# Python Client
[![PyPI version](https://badge.fury.io/py/Spraply-py.svg)](https://badge.fury.io/py/Spraply-py)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)

A Python client library for interacting with the Spraply API - a powerful web crawling and scraping service.
...
client = SpraplyAPIClient('your-api-key')
...
client = SpraplyAPIClient('your-api-key', base_url='https://custom-app.spraply.dev/')
```
...
Please see [CHANGELOG.md](https://github.com/Abhishek-yadv/Spraply-py/blob/main/CHANGELOG.md) for more information on what has changed recently.

## License

This project is licensed under the MIT License - see the [LICENSE](https://github.com/Abhishek-yadv/Spraply-py/blob/main/LICENSE) file for details.

## Support

For support, please visit:
- Issues: [GitHub Issues](https://github.com/Abhishek-yadv/Spraply-py/issues)
- Homepage: [GitHub Repository](https://github.com/Abhishek-yadv/Spraply-py)
- Documentation: [Spraply Docs](https://docs.spraply.dev/)
