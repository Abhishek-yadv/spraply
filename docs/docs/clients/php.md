...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/Spraply/php.svg?style=flat-square)](https://packagist.org/packages/Spraply/php)
[![Build Status](https://img.shields.io/github/actions/workflow/status/Abhishek-yadv/Spraply-php/release.yml?branch=main&style=flat-square)](https://github.com/Abhishek-yadv/Spraply-php/actions?query=workflow%3ARelease)
[![PHP Version Support](https://img.shields.io/packagist/php-v/Spraply/php?style=flat-square)](https://packagist.org/packages/Spraply/php)
[![Total Downloads](https://img.shields.io/packagist/dt/Spraply/php.svg?style=flat-square)](https://packagist.org/packages/Spraply/php)
[![License](https://img.shields.io/packagist/l/Spraply/php.svg?style=flat-square)](https://packagist.org/packages/Spraply/php)

PHP Client for Spraply REST APIs. This package provides a simple and elegant way to interact with Spraply's web scraping and crawling services.
...
Please see [CHANGELOG.md](https://github.com/Abhishek-yadv/Spraply-php/blob/main/CHANGELOG.md) for more information on what has changed recently.

## Contributing

Please see [CONTRIBUTING.md](https://github.com/Abhishek-yadv/Spraply-php/blob/main/CONTRIBUTING.md) for details.

## Security

If you discover any security related issues, please email security@spraply.dev instead of using the issue tracker.

## License

The MIT License (MIT). Please see [License File](https://github.com/Abhishek-yadv/Spraply-php/blob/main/LICENSE) for more information.
