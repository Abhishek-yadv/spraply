# Node.js Client
[![npm version](https://badge.fury.io/js/@Spraply%2Fnodejs.svg)](https://badge.fury.io/js/@Spraply%2Fnodejs)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

A TypeScript/Node.js client library for interacting with the Spraply API - a powerful web crawling and scraping service.

## Installation

```bash
npm install @Spraply/nodejs
```
...
```typescript
import { SpraplyAPIClient } from '@Spraply/nodejs';

// Initialize the client
const client = new SpraplyAPIClient('your-api-key');
...
const client = new SpraplyAPIClient('your-api-key', 'https://custom-app.spraply.dev/');
```
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/Abhishek-yadv/Spraply-nodejs/blob/main/LICENSE) file for details.

## Support

For support, please visit:
- Issues: [GitHub Issues](https://github.com/Abhishek-yadv/Spraply-nodejs/issues)
- Homepage: [GitHub Repository](https://github.com/Abhishek-yadv/Spraply-nodejs)
...
echo "Spraply_API_KEY=your-api-key" > .env
```
