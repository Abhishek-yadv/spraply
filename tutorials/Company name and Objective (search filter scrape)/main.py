...
Examples:
  ...
  python gpt41_professional.py "Example Inc." "Find company information" --is-url False
    ...
    parser.add_argument(
        ...
        help='Search depth for spraply API'
    )
    parser.add_argument(
        "--search-language", 
...
def main() -> None:  # noqa: D401
    ...
    api_key = os.environ.get('SPRAPLY_API_KEY')
    if not api_key:
        print("Error: SPRAPLY_API_KEY environment variable not set")
        sys.exit(1)

    wc = Spraplyer(api_key=api_key)
