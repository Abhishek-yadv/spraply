#!/usr/bin/env python3
"""
DeepSeek R1 spraply Live Chat with Your Website

This script allows users to have interactive conversations about website content using:
- spraply for web crawling and content extraction
...
class WebsiteChatBot:
    """A chatbot that can interact with website content using spraply and DeepSeek R1."""
    ...
    def __init__(self, api_keys: Dict[str, str]):
        ...
        Args:
            api_keys: Dictionary containing 'spraply' and 'deepseek' API keys
        """
        self.spraply = SpraplyAPIClient(api_key=api_keys['spraply'])
...
You can browse websites, extract information, and answer questions based on the content.""")
    ...
    def extract_website_content(self, url: str) -> Optional[str]:
        """
        Extract content from a website using spraply.
        ...
        try:
            with Progress(
                ...
                # Scrape the URL
                result = self.spraply.scrape_url(
                    url=url,
                    page_options={
...
def main():
    ...
    # Get API keys
    api_keys = {
        'spraply': os.getenv('SPRAPLY_API_KEY'),
        ...
        while True:
            try:
                ...
                if user_input.lower() in ('quit', 'exit', 'bye'):
                    console.print("Thank you for using the spraply Chatbot! Goodbye!")
                    break
                ...
                console.print("\n[bold green]spraply AI Assistant:[/bold green]")
